...
XPluginStart(char* outName, char* outSig, char* outDesc)
{
	...
	rootMenu = XPLMCreateMenu("UAVEE", XPLMFindPluginsMenu(), item, emptyHandler, NULL);
...
void
addCommandToMenu(const char* name, const char* description, XPLMCommandCallback_f func, int inBefore, void* inRefcon)
{
